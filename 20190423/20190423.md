...
- 각 VM의 가상 장치는 실제 HW를 공유해서 사용
  ...
  - WS2019 우측클릭 - 설정
    ...
    - 설치과정 :
      ...
      - ![1555994965309](C:\Users\user\Desktop\lecture_dir\1555994965309.png)
  
      - 비밀번호 통일 : Pa55w.rd
  
      - MS VM 들어가서 server management - local server - remote desktop enable해라
  
      - ![1555996555720](C:\Users\user\Desktop\lecture_dir\1555996555720.png)
  
      - 원격접속 ==> 인증서는 일단 그냥 예
  
      - ![1555996859250](C:\Users\user\Desktop\lecture_dir\1555996859250.png)
  ...
  - CentOS 설치
    - 소프트웨어 설치 : 서버 GUI
    - ![1555997930641](C:\Users\user\Desktop\lecture_dir\1555997930641.png)
    - 인터넷 설정
    - 하드 드라이브 : 자동 설정
    - PW 설정 : Pa55w.rd
    - 사용자 : centos
...
- 명령어 모음
  ...
  - ![1556002117001](C:\Users\user\Desktop\lecture_dir\1556002117001.png)
  - putty로 원격 접속 가능
...
- cloud computing 개관
  ...
  - Types of cloud service
    - ![1556006851498](C:\Users\user\Desktop\lecture_dir\1556006851498.png)
